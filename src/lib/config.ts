...
export const SITE_CONFIG: BlogConfig = {
  title: 'Ladder — the tech-career blog',
  description:
    'Honest, specific notes on tech careers — breaking into engineering, AI and SAP paths, AdSense and side income, and levelling up — by Chirag Singhal. No hustle-porn.',
  url: 'https://career-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-career') as `${string}/${string}`,
